...
def process_data(data):
  ...
  for item in data:
    ...
    if car_make in car_make_sales:
      car_make_sales[car_make] += sales
    else:
      car_make_sales[car_make] = sales
